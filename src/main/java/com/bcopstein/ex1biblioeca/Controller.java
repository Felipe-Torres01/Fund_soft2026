...
public class Controller {
    ...
    public List<Livro> getLivrosDoAutor(@PathVariable(value = "autor") String autor,
        ...
        estatisticas.informaConsultaAutor(autor.trim());
        return livros.getLivrosDoAutor(autor.trim(), ano);
    }

    @PostMapping("/novolivro")
    @CrossOrigin(origins = "*")
    public boolean cadastraLivroNovo(@RequestBody final Livro livro) {
        // o corpo já vem com a lista de autores (mínimo, com "nome" preenchido)
        return livros.cadastraLivroNovo(livro, livro.getAutores());
    }
